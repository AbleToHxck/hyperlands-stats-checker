import requests
value = input("Please enter a username: ")
stats = requests.get('https://api.hyperlandsmc.net/stats/{}'.format(value))
stats = stats.json()
if 'error' in stats and "Player not found" in stats['error']:
...
value2 = input("Press enter to exit.")
